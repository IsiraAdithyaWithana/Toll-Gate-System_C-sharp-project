...
namespace Expressway_Admin_loin
{
    public partial class Form9 : Form
    {
        ...
        private void Form9_Load(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection con1 = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\balas\OneDrive\Desktop\Expressway Project C#\Expressway Admin loin\Database1.mdf"";Integrated Security=True"))
                {
                    con1.Open();
